...
import { GetPostsByUserIdDocument, GetPostsByUserIdQuery, GetPostsByUserIdQueryVariables } from '@ngsocial/graphql/documents';
...
export class PostService {
	...
	getPostsByUserId(userId: string, offset?: number, limit?: number): any {
	...
	getFeed(offset?: number, limit?: number): any {}
}
